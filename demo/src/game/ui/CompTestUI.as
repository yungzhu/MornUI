	...
	public class CompTestUI extends Dialog {
		...
		private var uiXML:XML =
			<Dialog>
			  ...
			  <TextArea text="谷歌一直很重视Android系统缺乏足够的应用程序这方面的问题，公司认为新发布的Nexus平板将对这一问题的解决其促进作用。谷歌的Android产品经理雨果·巴拉（Hugo Barra）在接受科技网站the Verge的采访时表示，“公司投入大量精力推出Nexus 10平板，也是为了刺激开发者，让他们对Android应用的开发更有动力" x="35" y="324" width="150" height="100" scrollBarSkin="png.comp.vscroll" skin="png.comp.textinput"/>
